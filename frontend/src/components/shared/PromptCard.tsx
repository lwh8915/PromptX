        ...
        >
            ...
            <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                ...
                {onViewHistory && prompt.version_count > 1 && (
                    <button
                        onClick={onViewHistory}
                        className="btn btn-ghost !p-2 text-[var(--text-tertiary)] hover:text-blue-400 opacity-0 group-hover:opacity-100 transition-all"
                        title={`版本历史 (${prompt.version_count})`}
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                {onShare && (
                    <button
                        onClick={onShare}
                        className="btn btn-ghost !p-2 text-[var(--text-tertiary)] hover:text-green-400 opacity-0 group-hover:opacity-100 transition-all"
                        title="分享到公共库"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.368-2.684 3 3 0 00-5.368 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                ...
                <button
                    onClick={onDelete}
                    className="btn btn-ghost !p-2 text-[var(--text-tertiary)] hover:text-red-400 opacity-0 group-hover:opacity-100 transition-all"
                    title="删除"
                >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
